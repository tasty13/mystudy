...
insert into members(email,name,password)
  values('user1@test.com','user1',sha2('1111',256));
insert into members(email,name,password)
  values('user2@test.com','user2',sha2('1111',256));
insert into members(email,name,password)
  values('user3@test.com','user3',sha2('1111',256));
insert into members(email,name,password)
  values('user4@test.com','user4',sha2('1111',256));
insert into members(email,name,password)
  values('user5@test.com','user5',sha2('1111',256));
