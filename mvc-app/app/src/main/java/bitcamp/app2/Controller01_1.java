...
public class Controller01_1 {
  ...
  public void handler2(Model model) {
    ...
    // 뷰 이름을 리턴하지 않으면 request handler의 url을 상대 경로 view name으로 계산한다.
    // 즉 다음 리턴문과 같다: return "c01_1/h2"
    // 계산 방법
    // => 현재 URL = /app/c01_1/h2
    // => view URL = 현재 URL의 경로 + request handler의 URL
    //             = /웹애플리케이션경로/app/c01_1 + /c01_1/h2
    //             = /app/c01_1/c01_1/h2
    // 즉 return "/app/c01_1/c01_1/h2" 과 같다.
    // => 잘못 계산된 view URL로 JSP를 찾아서 오류 발생!
    //
